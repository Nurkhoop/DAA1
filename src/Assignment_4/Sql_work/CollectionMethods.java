...
public class CollectionMethods {
    ...
    public static void loadCollections(DefaultTableModel tableModel) {
        ...
        try (Connection connection = DatabaseConnection.getConnection();
            ...
            while (rs.next()) {
                ...
                tableModel.addRow(new Object[]{id, name, owner});
            }
        } catch (SQLException e) {
            System.err.println("SQL Exception in loadCollections(): " + e.getMessage());
        }
    }
}